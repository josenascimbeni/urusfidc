...
export default function Home() {
  ...
  function saveFidc() {
    ...
    if (!editingFidcId) {
      setTemplates((items) => [...items, { id: `tpl-${savedId}`, name: `Adicionais de ${saved.name}`, scope: "FIDC", fidcId: savedId, status: "Ativo", activeVersion: 1, versions: [{ id: `tpl-${savedId}-v1`, version: 1, createdAt: "16/08/2026", createdBy: session?.id ?? "admin", items: [] }] }]);
    }
